...
INSERT INTO `__new_wolf_decisions`("id", "round_id", "group_id", "hole_number", "wolf_player_id", "decision", "partner_player_id", "bonuses_json", "outcome", "created_at") SELECT "id", "round_id", "group_id", "hole_number", "wolf_player_id", "decision", "partner_player_id", NULL, "outcome", "created_at" FROM `wolf_decisions`;--> statement-breakpoint
...
CREATE UNIQUE INDEX `uniq_wolf_decisions` ON `wolf_decisions` (`round_id`,`group_id`,`hole_number`);--> statement-breakpoint
